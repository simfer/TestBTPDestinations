		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SalesOrders",
									"targetURL": "#mycompanysalesorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mycompanysalesorders-display": {
								"semanticObject": "mycompanysalesorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=my.company.salesorders",
									"url": sap.ui.require.toUrl("my/company/salesorders")
								}
							}
						}
					}
